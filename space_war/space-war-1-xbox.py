...
def setup():
    ...
    mob1 = Mob(128, 64, mob2_img)
    mob2 = Mob(256, 64, mob2_img)
    mob3 = Mob(384, 64, mob2_img)
    mob4 = Mob(128, 150, mob_img)
    mob5 = Mob(256, 150, mob_img)
    mob6 = Mob(384, 150, mob_img)
    mob7 = Mob(128, 50, mob_img)
